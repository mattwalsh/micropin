...
$0153          78       MOV A,B
$0154          e6 10    ANI #10
$0156 o0156:   c2 68 01 JNZ jo0168
$0159          78       MOV A,B
$015a          e6 40    ANI #40
$015c o015c:   c2 68 01 JNZ jo0168
$015f          21 ff 12 LXI H, GAME_OVER_MUSIC
$0162 o0162:   cd 61 12 CALL PLAY_SOUND
$0165 o0165:   c3 bf 01 JMP j01bf
$0168 jo0168:  cd a8 17 CALL c17a8 ;o0148,o0156,o015c
$016b          3e d0    MVI A, #d0
...
$029e FLIPPER_HOLD_ROUTINE:
         3a c3 21 LDA $21c3 ;o0870
$02a1          e6 10    ANI #10
$02a3 o02a3:   ca 7b 08 JZ j087b
$02a6          db 04    IN PRICE_89_CAB
$02a8          e6 20    ANI #20
$02aa o02aa:   ca 91 08 JZ j0891
$02ad          3e 09    MVI A, #09
$02af          32 a8 21 STA $21a8
$02b2 o02b2:   c3 1e 06 JMP END_MAIN_LOOP
$02b5 j02b5:   3a c3 21 LDA $21c3 ;o092d
$02b8          e6 20    ANI #20
$02ba o02ba:   ca 38 09 JZ j0938
$02bd          db 04    IN PRICE_89_CAB
$02bf          e6 40    ANI #40
$02c1 o02c1:   ca 4e 09 JZ j094e
$02c4          3e 09    MVI A, #09
$02c6          32 a9 21 STA $21a9
$02c9 o02c9:   c3 1e 06 JMP END_MAIN_LOOP
$02cc          06 0c    MVI B, #0c
...
$0870 o0870:   c3 9e 02 JMP FLIPPER_HOLD_ROUTINE
$0873          3e 04    MVI A, #04
$0875 o0875:   cd ee 03 CALL CHECK_ATH_BIT_OF_HL
$0878 o0878:   c2 91 08 JNZ j0891
$087b j087b:   21 90 21 LXI H, GAME_STATE ;o02a3
$087e          3e 02    MVI A, #02
...
; right flipper
$0891 j0891:   3a c3 21 LDA $21c3 ;o02aa,o0878
$0894          e6 2f    ANI #2f
...
$094e j094e:   3a c3 21 LDA $21c3 ;o02c1,o0935
$0951          e6 1f    ANI #1f
