...
$0113 j0113:   db 04    IN #04 ;o00c8,o02dc
$0115          e6 20    ANI #20
...
$014b          32 7a 23 STA $237a
$014e          32 9a 23 STA $239a
$0151          32 ba 23 STA $23ba
$0154          3e 0f    MVI A, #0f
$0156          32 7b 23 STA $237b
$0159          32 9b 23 STA $239b
$015c          32 bb 23 STA $23bb
...
$01a2 j01a2:   db 02    IN #02 ;o019a,o1c25,o1c2b,o1c34,o1c50
$01a4          0e 00    MVI C, #00
$01a6          06 08    MVI B, #08
...
$01de          07       RLC
$01df          b2       ORA D
$01e0          32 7f 23 STA $237f
$01e3          32 9f 23 STA $239f
$01e6          32 bf 23 STA $23bf
$01e9          fb       EI
$01ea          db 05    IN #05
$01ec          21 16 22 LXI H, #2216
$01ef          77       MOV M,A
$01f0          06 03    MVI B, #03
$01f2          3e 00    MVI A, #00
...
$0509          3a 13 22 LDA $2213
$050c          32 7b 23 STA $237b
...
$0865          32 9a 23 STA $239a
$0868          32 ba 23 STA $23ba
$086b          3a 21 22 LDA $2221
$086e          32 9f 23 STA $239f
$0871          32 bf 23 STA $23bf
...
$098a c098a:   3a 7a 23 LDA $237a ;jo0968,o0a37
$098d          fe 99    CPI #99
$098f          c8       RZ
$0990          21 7c 23 LXI H, #237c
$0993          3a 7f 23 LDA $237f
$0996          86       ADD M
$0997          27       DAA
...
$09c8          3a 7a 23 LDA $237a
$09cb          3c       INR A
$09cc          27       DAA
$09cd          32 7a 23 STA $237a
$09d0          32 9a 23 STA $239a
$09d3          32 ba 23 STA $23ba
...
$167c j167c:   3a 7b 23 LDA $237b ;o1666
$167f          e6 0f    ANI #0f
$1681          fe 01    CPI #01
...
$16cb          3e 00    MVI A, #00
$16cd j16cd:   32 7b 23 STA $237b ;o16ae
$16d0          32 9b 23 STA $239b
$16d3          32 bb 23 STA $23bb
$16d6          3e 11    MVI A, #11
...
$172c j172c:   3a 7a 23 LDA $237a ;o17e4
$172f          c6 99    ADI #99
$1731          27       DAA
$1732          32 7a 23 STA $237a
$1735          32 9a 23 STA $239a
$1738          32 ba 23 STA $23ba
$173b          3a 14 22 LDA $2214
$173e          47       MOV B,A
$173f          3a 13 22 LDA $2213
$1742          80       ADD B
...
$17e7 j17e7:   db 05    IN #05 ;o1746
$17e9          e6 80    ANI #80
$17eb o17eb:   c2 fd 17 JNZ j17fd
$17ee          3a 7a 23 LDA $237a
$17f1          b7       ORA A
...
$19b9 j19b9:   3a 7b 23 LDA $237b ;o199a
$19bc          b7       ORA A
$19bd          3e 01    MVI A, #01
...
$19e1          3a 13 22 LDA $2213
$19e4          3c       INR A
$19e5          47       MOV B,A
$19e6          3a 7b 23 LDA $237b
$19e9          3c       INR A
$19ea          b8       CMP B
...
$1a31          3e 00    MVI A, #00
$1a33          32 9b 23 STA $239b
$1a36          32 bb 23 STA $23bb
$1a39          3e fa    MVI A, #fa
$1a3b          32 9e 21 STA $219e
$1a3e          3a 16 22 LDA $2216
$1a41          e6 04    ANI #04
...
$1a5b j1a5b:   32 7b 23 STA $237b ;o19c2,o19eb,o19f8
$1a5e          32 9b 23 STA $239b
$1a61          32 bb 23 STA $23bb
$1a64          3e 04    MVI A, #04
$1a66          21 7e 23 LXI H, #237e
$1a69 jo1a69:  cd ce 03 CALL c03ce ;o19de
$1a6c          3a 13 22 LDA $2213
$1a6f          4f       MOV C,A
$1a70          3a 7b 23 LDA $237b
$1a73          b9       CMP C
...
$1b8e j1b8e:   3a 7a 23 LDA $237a ;o1b87
$1b91          90       SUB B
