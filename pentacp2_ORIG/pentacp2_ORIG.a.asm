; BOGUS address $137d found in          cd 7d 13 CALL $137d at $0140
; BOGUS address $cc21 found in          cd 21 cc CALL $cc21 at $0445
; BOGUS address $ca21 found in          cc 21 ca CZ $ca21 at $044b
; BOGUS address $044f found in          cd 4f 04 CALL $044f at $047b
; BOGUS address $044f found in          cd 4f 04 CALL $044f at $0591
; BOGUS address $9d18 found in          cd 18 9d CALL $9d18 at $075a
; BOGUS address $c421 found in          c3 21 c4 JMP $c421 at $080d
; BOGUS address $c421 found in          c3 21 c4 JMP $c421 at $0813
; BOGUS address $ad21 found in          c4 21 ad CNZ $ad21 at $0819
; BOGUS address $c221 found in          c4 21 c2 CNZ $c221 at $0bcf
; BOGUS address $6921 found in          c2 21 69 JNZ $6921 at $0bd5
; BOGUS address $ff08 found in          ca 08 ff JZ $ff08 at $12ad
; BOGUS address $ca08 found in          ca 08 ca JZ $ca08 at $1338
; BOGUS address $ca08 found in          ca 08 ca JZ $ca08 at $133c
; BOGUS address $ff00 found in          ca 00 ff JZ $ff00 at $134e
; BOGUS address $ca0c found in          ca 0c ca JZ $ca0c at $1357
; BOGUS address $ca08 found in          ca 08 ca JZ $ca08 at $135b
; BOGUS address $aa08 found in          ca 08 aa JZ $aa08 at $135f
...
$0032          76       HLT
$0033          00       NOP
$0034 o0034:   c3 86 03 JMP jo0386
$0037          76       HLT
$0038          76       HLT
$0039          76       HLT
$003a          76       HLT
...
$0069 j0069:   31 90 21 LXI SP, #2190 ;o0024,o005a
$006c          3e 07    MVI A, #07
$006e j006e:   d3 0e    OUT #0e ;o0073
$0070          d3 0d    OUT #0d
$0072          3d       DCR A
...
$00ae          3a 90 21 LDA $2190
$00b1          f6 05    ORI #05
$00b3          32 90 21 STA $2190
$00b6          3e 0c    MVI A, #0c
$00b8          30       SIM
$00b9          db 04    IN #04
$00bb          e6 20    ANI #20
...
$00d1          3e 08    MVI A, #08
$00d3 o00d3:   cd cf 0e CALL c0ecf
$00d6          3e 71    MVI A, #71
...
$013d          d3 08    OUT #08
$013f          f3       DI
$0140          cd 7d 13 DB 0xcd,0x7d,0x13  ; (was:          cd 7d 13 CALL $137d)
$0143 j0143:   db 04    IN #04 ;o00f8,o0300
$0145          e6 20    ANI #20
$0147 o0147:   c2 68 01 JNZ jo0168
$014a          3a 92 21 LDA $2192
$014d          3e d0    MVI A, #d0
$014f          32 92 21 STA $2192
$0152          db 03    IN #03
$0154          fe fe    CPI #fe
...
$016b          3e d0    MVI A, #d0
$016d          32 92 21 STA $2192
$0170          3e 00    MVI A, #00
$0172          32 7e 23 STA $237e
$0175          32 9e 23 STA $239e
$0178          32 be 23 STA $23be
$017b          32 7a 23 STA $237a
$017e          32 9a 23 STA $239a
$0181          32 ba 23 STA $23ba
$0184          3e 0f    MVI A, #0f
$0186          32 7b 23 STA $237b
$0189          32 9b 23 STA $239b
$018c          32 bb 23 STA $23bb
$018f          32 96 23 STA $2396
$0192          32 b6 23 STA $23b6
$0195          21 a3 23 LXI H, #23a3
$0198          11 20 23 LXI D, #2320
$019b          3e 2e    MVI A, #2e
$019d o019d:   cd cf 0e CALL c0ecf
$01a0          06 01    MVI B, #01
...
$01ae          3e 0a    MVI A, #0a
$01b0 o01b0:   cd cf 0e CALL c0ecf
...
$01c0          3e 30    MVI A, #30
$01c2          32 94 21 STA $2194
$01c5          3a 92 21 LDA $2192
$01c8          e6 80    ANI #80
$01ca o01ca:   c2 d2 01 JNZ j01d2
$01cd          3e 00    MVI A, #00
$01cf          32 92 21 STA $2192
$01d2 j01d2:   db 02    IN #02 ;o01ca,o1c45,o1c4b,o1c54,o1c70
$01d4          2f       CMA
$01d5          6f       MOV L,A
$01d6          db 04    IN #04
$01d8          2f       CMA
...
$0201          e6 f0    ANI #f0
$0203          80       ADD B
$0204          32 7f 23 STA $237f
$0207          32 9f 23 STA $239f
$020a          32 bf 23 STA $23bf
$020d          fb       EI
$020e          db 05    IN #05
$0210          21 16 22 LXI H, #2216
$0213          77       MOV M,A
$0214          06 03    MVI B, #03
$0216          3e 00    MVI A, #00
$0218 o0218:   cd ee 03 CALL c03ee
$021b o021b:   c2 28 02 JNZ j0228
$021e          04       INR B
$021f          3e 01    MVI A, #01
$0221 o0221:   cd ee 03 CALL c03ee
$0224 o0224:   c2 28 02 JNZ j0228
$0227          04       INR B
$0228 j0228:   78       MOV A,B ;o021b,o0224
$0229          32 13 22 STA $2213
$022c j022c:   d3 0f    OUT #0f ;o028f,o1c7b,o1cc0,o1ccb,o1cd9,o1d63
$022e          fb       EI
$022f          00       NOP
$0230          fb       EI
$0231          00       NOP
...
$027c          21 92 21 LXI H, #2192
$027f          3e 07    MVI A, #07
$0281 o0281:   cd ee 03 CALL c03ee
$0284 o0284:   c2 b9 1b JNZ j1bb9
$0287          3a b6 23 LDA $23b6
$028a          e6 bf    ANI #bf
$028c          32 b6 23 STA $23b6
$028f o028f:   c3 2c 02 JMP j022c
$0292 c0292:   eb       XCHG ;o07c8,o0ce8,o0dc5,o0dd4,o14b7,o15ca,o18d9
...
$032e          c9       RET
$032f          2d       DCR L
$0330 jo0330:  cd 24 06 CALL c0624 ;o002c
$0333          3a 90 21 LDA $2190
$0336          f6 80    ORI #80
$0338          32 90 21 STA $2190
$033b          db 01    IN #01
...
$0354 o0354:   cd ee 03 CALL c03ee
$0357 o0357:   c2 82 03 JNZ jo0382
$035a o035a:   cd 24 06 CALL c0624
$035d          3a 91 21 LDA $2191
$0360          e6 02    ANI #02
$0362 o0362:   c4 02 04 CNZ c0402
$0365 o0365:   cd 30 06 CALL c0630
$0368 o0368:   cd d6 03 CALL c03d6
$036b          eb       XCHG
$036c          29       DAD H
...
$0374          6f       MOV L,A
$0375          e9       PCHL
$0376 j0376:   21 94 21 LXI H, #2194 ;o0606,o13e7,o178b
...
$039c          d3 0d    OUT #0d
$039e          2f       CMA
$039f          21 94 21 LXI H, #2194
$03a2 o03a2:   cd ee 03 CALL c03ee
$03a5 o03a5:   c2 82 03 JNZ jo0382
$03a8 o03a8:   cd d6 03 CALL c03d6
$03ab          eb       XCHG
$03ac          29       DAD H
...
$03d4          7b       MOV A,E
$03d5          04       INR B
$03d6 c03d6:   c5       PUSH B ;o0368,o03a8,o0410,o052e,o06cb,o079f,o09c0,o09cf,o09f6,o0aa1,o0af2,o0b55,o0c98,o0c9e,o0d52,jo1078,jo10ad,o11f8,o1213,o1283,o13c1,o13fb,o1499,o1568,o15c4,o1657,o170a,jo1738,jo174e,o184b,o1853,o19a3,o19dc,jo1a98,o1aab,o1b6c,o1c42,o1c7e,o1d1f,o1d56,o1d79,o1d7d,o1d94
$03d7          47       MOV B,A
$03d8 o03d8:   cd f9 03 CALL c03f9
$03db          4e       MOV C,M
$03dc          b1       ORA C
$03dd          77       MOV M,A
$03de o03de:   c3 f6 03 JMP j03f6
$03e1 c03e1:   c5       PUSH B ;jo037f,o0423,o06bd,o06d8,o06de,o06e4,o0716,o088b,o0948,o09e7,jo09fc,o0a4d,o0a5b,o0ba4,o0bb4,jo107d,o10ba,o10bf,jo1222,jo1255,o1382,o13e1,o13f1,jo1402,o14ae,o1541,o15e9,o16a7,o1923,jo1955,o199d,o1abf,o1acc,jo1c48,o1c6a,o1d4e,o1d6b,o1d84,o1d8c,o1d98
$03e2          47       MOV B,A
$03e3 o03e3:   cd f9 03 CALL c03f9
$03e6          2f       CMA
$03e7          4f       MOV C,A
$03e8          7e       MOV A,M
$03e9          a1       ANA C
...
$03f7          c1       POP B
$03f8          c9       RET
$03f9 c03f9:   4f       MOV C,A ;o03d8,o03e3,o03f0
$03fa          3e 01    MVI A, #01
...
$0409 o0409:   cd ee 03 CALL c03ee
$040c o040c:   ca 13 04 JZ j0413
$040f          eb       XCHG
$0410 o0410:   cd d6 03 CALL c03d6
...
$0422          eb       XCHG
$0423 o0423:   cd e1 03 CALL c03e1
$0426          c9       RET
...
$0440          04       INR B
$0441          00       NOP
$0442          01 02 05 LXI B, #0502
$0445          cd 21 cc DB 0xcd,0x21,0xcc  ; (was:          cd 21 cc CALL $cc21)
$0448          21 cc 21 LXI H, #21cc
$044b          cc 21 ca DB 0xcc,0x21,0xca  ; (was:          cc 21 ca CZ $ca21)
$044e          21 3a 90 LXI H, #903a
$0451          21 f6 05 LXI H, #05f6
$0454          32 90 21 STA $2190
$0457          3e 00    MVI A, #00
$0459          32 0c 22 STA $220c
$045c          3e ff    MVI A, #ff
$045e          32 93 21 STA $2193
$0461          3a 94 21 LDA $2194
$0464          f6 30    ORI #30
$0466          32 94 21 STA $2194
$0469          c9       RET
$046a c046a:   3a 92 21 LDA $2192 ;o0483,o058b
$046d          e6 40    ANI #40
$046f          c8       RZ
$0470          3a 7a 23 LDA $237a
$0473          b7       ORA A
...
$047a          c9       RET
$047b          cd 4f 04 DB 0xcd,0x4f,0x4  ; (was:          cd 4f 04 CALL $044f)
$047e          3e 7d    MVI A, #7d
...
$04aa          90       SUB B
$04ab o04ab:   fa 43 05 JM j0543
$04ae          3a 92 21 LDA $2192
$04b1          e6 40    ANI #40
$04b3 o04b3:   c2 43 05 JNZ j0543
$04b6          3a 94 21 LDA $2194
$04b9          f6 fc    ORI #fc
$04bb          32 94 21 STA $2194
...
$04f2          3a 90 21 LDA $2190
$04f5          e6 f7    ANI #f7
$04f7          32 90 21 STA $2190
...
$050f          3e d0    MVI A, #d0
$0511          32 92 21 STA $2192
$0514          3a 13 22 LDA $2213
$0517          32 7b 23 STA $237b
...
$052c          c6 04    ADI #04
$052e o052e:   cd d6 03 CALL c03d6
$0531          3e 01    MVI A, #01
...
$0543 j0543:   21 c2 12 LXI H, #12c2 ;o04ab,o04b3
$0546 o0546:   cd 61 12 CALL c1261
...
$0560          21 bf 12 LXI H, #12bf
$0563 o0563:   cd 61 12 CALL c1261
$0566 o0566:   c3 1e 06 JMP jo061e
...
$0591          cd 4f 04 DB 0xcd,0x4f,0x4  ; (was:          cd 4f 04 CALL $044f)
$0594          3e 7d    MVI A, #7d
$0596          32 a2 21 STA $21a2
$0599          21 c2 12 LXI H, #12c2
$059c o059c:   cd 61 12 CALL c1261
$059f o059f:   c3 1e 06 JMP jo061e
$05a2 j05a2:   3a 94 21 LDA $2194 ;o0588,o058e
$05a5          e6 77    ANI #77
$05a7          32 94 21 STA $2194
$05aa o05aa:   c3 1e 06 JMP jo061e
$05ad          21 92 21 LXI H, #2192
$05b0          3e 07    MVI A, #07
$05b2 o05b2:   cd ee 03 CALL c03ee
$05b5 o05b5:   ca 1e 06 JZ jo061e
...
$05d6 o05d6:   c3 1e 06 JMP jo061e
...
$060a o060a:   cd 24 06 CALL c0624
$060d          3e 1a    MVI A, #1a
$060f          91       SUB C
$0610          87       ADD A
...
$061c          6f       MOV L,A
$061d          e9       PCHL
$061e jo061e:  cd 30 06 CALL c0630 ;o0566,o0581,o059f,o05aa,o05b5,o05d6,o071e,o0729,o07e8,o07f0,o07fb,o0803,o0883,o088e,o08a1,o08c8,o08da,o08f1,o0906,o0940,o094b,o095e,o0a6d,o0a90,o0aa9,o0abb,o0ae9,o0b4f,o0ba7,o0bb7,o0cc1,o0cf6,o0d26,o0de9,o121f,o123e,o1252,o125e,o14f7,o152b,o18e7,o1911,o1a37,o1a6e,o1a87,o1ad4,o1aec,jo1ba5,o1d73
$0621 o0621:   c3 e8 05 JMP j05e8
$0624 c0624:   22 95 21 SHLD $2195 ;jo0330,o035a,jo0386,o060a,o1406
$0627          e3       XTHL
$0628          c5       PUSH B
$0629          d5       PUSH D
$062a          f5       PUSH PSW
$062b          e5       PUSH H
$062c          2a 95 21 LHLD $2195
$062f          c9       RET
$0630 c0630:   e1       POP H ;o0365,jo0382,jo061e,jo1419
$0631          f1       POP PSW
$0632          d1       POP D
$0633          c1       POP B
$0634          e3       XTHL
...
$0655          3e 40    MVI A, #40
$0657 o0657:   cd cf 0e CALL c0ecf
...
$0681          3e 40    MVI A, #40
$0683 o0683:   cd cf 0e CALL c0ecf
...
$06a1          2f       CMA
$06a2          d3 04    OUT #04
$06a4 j06a4:   db 04    IN #04 ;o0678
$06a6          e6 10    ANI #10
$06a8 o06a8:   c2 b4 06 JNZ jc06b4
$06ab          3a 92 21 LDA $2192
$06ae          f6 20    ORI #20
$06b0          32 92 21 STA $2192
$06b3          c9       RET
$06b4 jc06b4:  21 92 21 LXI H, #2192 ;o0003,o06a8
$06b7          3e 05    MVI A, #05
$06b9 o06b9:   cd ee 03 CALL c03ee
$06bc          c8       RZ
$06bd o06bd:   cd e1 03 CALL c03e1
$06c0          3a 7a 23 LDA $237a
$06c3          fe 99    CPI #99
$06c5          c8       RZ
$06c6          21 c5 21 LXI H, #21c5
$06c9          3e 03    MVI A, #03
$06cb o06cb:   cd d6 03 CALL c03d6
$06ce          3e 09    MVI A, #09
$06d0          32 ab 21 STA $21ab
$06d3 c06d3:   3e 06    MVI A, #06 ;jo1a71
$06d5          21 76 23 LXI H, #2376
$06d8 o06d8:   cd e1 03 CALL c03e1
$06db          21 96 23 LXI H, #2396
$06de o06de:   cd e1 03 CALL c03e1
$06e1          21 b6 23 LXI H, #23b6
$06e4 o06e4:   cd e1 03 CALL c03e1
$06e7          06 00    MVI B, #00
$06e9 o06e9:   cd 81 1d CALL co1d81
$06ec          3a 7a 23 LDA $237a
$06ef          3c       INR A
$06f0          27       DAA
$06f1          32 7a 23 STA $237a
$06f4          32 9a 23 STA $239a
$06f7          32 ba 23 STA $23ba
$06fa          21 41 13 LXI H, #1341
$06fd o06fd:   cd 61 12 CALL c1261
...
$070e          3e 03    MVI A, #03
$0710 o0710:   cd ee 03 CALL c03ee
$0713 o0713:   ca 21 07 JZ j0721
$0716 o0716:   cd e1 03 CALL c03e1
$0719          3e 09    MVI A, #09
$071b          32 ab 21 STA $21ab
$071e o071e:   c3 1e 06 JMP jo061e
$0721 j0721:   3a 94 21 LDA $2194 ;o0713
$0724          e6 bb    ANI #bb
$0726          32 94 21 STA $2194
$0729 o0729:   c3 1e 06 JMP jo061e
$072c          aa       XRA D
$072d          0b       DCX B
$072e          06 12    MVI B, #12
$0730          ce 07    ACI #07
...
$0758          f3       DI
$0759          07       RLC
$075a          cd 18 9d DB 0xcd,0x18,0x9d  ; (was:          cd 18 9d CALL $9d18)
$075d          0d       DCR C
$075e          1e 06    MVI E, #06
...
$079d          66       MOV H,M
$079e          68       MOV L,B
$079f o079f:   cd d6 03 CALL c03d6
$07a2          3e 09    MVI A, #09
...
$07ba          68       MOV L,B
$07bb          d5       PUSH D
$07bc o07bc:   cd 61 12 CALL c1261
$07bf          d1       POP D
...
$07c6          66       MOV H,M
$07c7          68       MOV L,B
$07c8 o07c8:   cd 92 02 CALL c0292
...
$07e7          b7       ORA A
$07e8 o07e8:   c2 1e 06 JNZ jo061e
$07eb          3e 06    MVI A, #06
$07ed          32 ad 21 STA $21ad
$07f0 o07f0:   c3 1e 06 JMP jo061e
$07f3          21 90 21 LXI H, #2190
$07f6          3e 02    MVI A, #02
$07f8 o07f8:   cd ee 03 CALL c03ee
$07fb o07fb:   c2 1e 06 JNZ jo061e
$07fe          3e 80    MVI A, #80
$0800          32 93 21 STA $2193
$0803 o0803:   c3 1e 06 JMP jo061e
$0806          03       INX B
$0807          00       NOP
$0808          01 02 03 LXI B, #0302
$080b          04       INR B
$080c          02       STAX B
$080d          c3 21 c4 DB 0xc3,0x21,0xc4  ; (was:          c3 21 c4 JMP $c421)
$0810          21 c4 21 LXI H, #21c4
$0813          c3 21 c4 DB 0xc3,0x21,0xc4  ; (was:          c3 21 c4 JMP $c421)
$0816          21 c4 21 LXI H, #21c4
$0819          c4 21 ad DB 0xc4,0x21,0xad  ; (was:          c4 21 ad CNZ $ad21)
$081c          12       STAX D
$081d          b0       ORA B
$081e          12       STAX D
$081f          b3       ORA E
...
$0847          21 90 21 LXI H, #2190
$084a          3e 05    MVI A, #05
$084c o084c:   cd ee 03 CALL c03ee
$084f o084f:   c2 82 03 JNZ jo0382
$0852          21 4e 13 LXI H, #134e
$0855 o0855:   cd 61 12 CALL c1261
$0858          3e 04    MVI A, #04
$085a          32 22 22 STA $2222
$085d          21 91 21 LXI H, #2191
$0860          3e 00    MVI A, #00
$0862 o0862:   cd ee 03 CALL c03ee
...
$0873          3e 04    MVI A, #04
$0875 o0875:   cd ee 03 CALL c03ee
$0878 o0878:   c2 91 08 JNZ j0891
$087b          21 90 21 LXI H, #2190
$087e          3e 02    MVI A, #02
$0880 o0880:   cd ee 03 CALL c03ee
$0883 o0883:   c2 1e 06 JNZ jo061e
$0886          3e 04    MVI A, #04
$0888          21 94 21 LXI H, #2194
$088b o088b:   cd e1 03 CALL c03e1
$088e o088e:   c3 1e 06 JMP jo061e
...
$08a1 o08a1:   c3 1e 06 JMP jo061e
...
$08c8 o08c8:   c2 1e 06 JNZ jo061e
$08cb          3e 3c    MVI A, #3c
...
$08d8          fe 60    CPI #60
$08da o08da:   c2 1e 06 JNZ jo061e
$08dd          3e 00    MVI A, #00
...
$08f1 o08f1:   c2 1e 06 JNZ jo061e
...
$0906 o0906:   c3 1e 06 JMP jo061e
...
$0919          21 90 21 LXI H, #2190
$091c          3e 05    MVI A, #05
$091e o091e:   cd ee 03 CALL c03ee
$0921 o0921:   c2 82 03 JNZ jo0382
$0924          21 4e 13 LXI H, #134e
$0927 o0927:   cd 61 12 CALL c1261
$092a o092a:   c3 82 03 JMP jo0382
$092d          21 c3 21 LXI H, #21c3
$0930          3e 05    MVI A, #05
$0932 o0932:   cd ee 03 CALL c03ee
$0935 o0935:   c2 4e 09 JNZ j094e
$0938          21 90 21 LXI H, #2190
$093b          3e 02    MVI A, #02
$093d o093d:   cd ee 03 CALL c03ee
$0940 o0940:   c2 1e 06 JNZ jo061e
$0943          21 94 21 LXI H, #2194
$0946          3e 05    MVI A, #05
$0948 o0948:   cd e1 03 CALL c03e1
$094b o094b:   c3 1e 06 JMP jo061e
...
$095e o095e:   c3 1e 06 JMP jo061e
$0961          06 24    MVI B, #24
$0963          0e 00    MVI C, #00
...
$09bb j09bb:   21 90 21 LXI H, #2190 ;o09a3
$09be          3e 07    MVI A, #07
$09c0 o09c0:   cd d6 03 CALL c03d6
$09c3          3e 02    MVI A, #02
$09c5 o09c5:   cd ee 03 CALL c03ee
$09c8 o09c8:   ca da 09 JZ jo09da
$09cb          79       MOV A,C
$09cc o09cc:   cd 6f 0b CALL c0b6f
$09cf o09cf:   cd d6 03 CALL c03d6
$09d2          3e 06    MVI A, #06
...
$09e1 o09e1:   cd ee 03 CALL c03ee
$09e4 o09e4:   ca 52 0b JZ jo0b52
$09e7 o09e7:   cd e1 03 CALL c03e1
$09ea          21 11 22 LXI H, #2211
$09ed          be       CMP M
$09ee          21 92 21 LXI H, #2192
$09f1          3e 01    MVI A, #01
$09f3 o09f3:   c2 fc 09 JNZ jo09fc
$09f6 o09f6:   cd d6 03 CALL c03d6
$09f9 o09f9:   c3 ff 09 JMP j09ff
$09fc jo09fc:  cd e1 03 CALL c03e1 ;o09f3
...
$0a09          eb       XCHG
$0a0a          19       DAD D
$0a0b o0a0b:   cd ee 03 CALL c03ee
$0a0e          eb       XCHG
$0a0f          3e 01    MVI A, #01
$0a11 o0a11:   ca 24 0a JZ j0a24
$0a14 jo0a14:  cd 91 1d CALL co1d91 ;o0a06
$0a17          21 e3 12 LXI H, #12e3
$0a1a o0a1a:   cd 61 12 CALL c1261
$0a1d          3e c8    MVI A, #c8
...
$0a3c          21 dd 12 LXI H, #12dd
$0a3f o0a3f:   cd 61 12 CALL c1261
$0a42          21 92 21 LXI H, #2192
$0a45          3e 01    MVI A, #01
$0a47 o0a47:   cd ee 03 CALL c03ee
$0a4a o0a4a:   ca 93 0a JZ j0a93
$0a4d o0a4d:   cd e1 03 CALL c03e1
$0a50          21 91 21 LXI H, #2191
$0a53          3e 01    MVI A, #01
$0a55 o0a55:   cd ee 03 CALL c03ee
$0a58 o0a58:   ca 93 0a JZ j0a93
$0a5b o0a5b:   cd e1 03 CALL c03e1
$0a5e          3e fa    MVI A, #fa
...
$0a6d o0a6d:   c3 1e 06 JMP jo061e
$0a70          21 71 11 LXI H, #1171
$0a73 o0a73:   cd 5c 0e CALL c0e5c
$0a76          21 35 13 LXI H, #1335
$0a79 o0a79:   cd 61 12 CALL c1261
...
$0abb o0abb:   c3 1e 06 JMP jo061e
$0abe          97       SUB A
...
$0ad9          21 dd 12 LXI H, #12dd
$0adc o0adc:   cd 61 12 CALL c1261
$0adf          3e 0f    MVI A, #0f
$0ae1          32 a5 21 STA $21a5
$0ae4          3e 64    MVI A, #64
$0ae6          32 08 22 STA $2208
$0ae9 o0ae9:   c3 1e 06 JMP jo061e
$0aec j0aec:   2a 09 22 LHLD $2209 ;o0acb
$0aef          3a 0b 22 LDA $220b
$0af2 o0af2:   cd d6 03 CALL c03d6
$0af5          3e 06    MVI A, #06
...
$0b0e          21 90 21 LXI H, #2190
$0b11          3e 03    MVI A, #03
$0b13 o0b13:   cd ee 03 CALL c03ee
...
$0ba2          3e 01    MVI A, #01
$0ba4 o0ba4:   cd e1 03 CALL c03e1
$0ba7 o0ba7:   c3 1e 06 JMP jo061e
$0baa          3e 00    MVI A, #00
$0bac          32 08 22 STA $2208
$0baf          21 92 21 LXI H, #2192
$0bb2          3e 03    MVI A, #03
$0bb4 o0bb4:   cd e1 03 CALL c03e1
$0bb7 o0bb7:   c3 1e 06 JMP jo061e
$0bba          24       INR H
$0bbb          03       INX B
$0bbc          0b       DCX B
$0bbd          13       INX D
...
$0bcf          c4 21 c2 DB 0xc4,0x21,0xc2  ; (was:          c4 21 c2 CNZ $c221)
$0bd2          21 c2 21 LXI H, #21c2
$0bd5          c2 21 69 DB 0xc2,0x21,0x69  ; (was:          c2 21 69 JNZ $6921)
...
$0be7          21 90 21 LXI H, #2190
$0bea          3e 02    MVI A, #02
$0bec o0bec:   cd ee 03 CALL c03ee
...
$0c00          3e 06    MVI A, #06
$0c02 o0c02:   cd cf 0e CALL c0ecf
$0c05          06 38    MVI B, #38
...
$0c36          21 21 13 LXI H, #1321
$0c39 o0c39:   cd 61 12 CALL c1261
...
$0c96          3e 05    MVI A, #05
$0c98 o0c98:   cd d6 03 CALL c03d6
$0c9b          21 b6 23 LXI H, #23b6
$0c9e o0c9e:   cd d6 03 CALL c03d6
$0ca1          3e fa    MVI A, #fa
...
$0cb9          3a 94 21 LDA $2194
$0cbc          e6 fd    ANI #fd
$0cbe          32 94 21 STA $2194
$0cc1 o0cc1:   c3 1e 06 JMP jo061e
$0cc4 j0cc4:   3e 00    MVI A, #00 ;o0cb6
$0cc6          32 97 21 STA $2197
$0cc9          3a 94 21 LDA $2194
$0ccc          f6 02    ORI #02
$0cce          32 94 21 STA $2194
$0cd1          21 90 21 LXI H, #2190
$0cd4          3e 00    MVI A, #00
$0cd6 o0cd6:   cd ee 03 CALL c03ee
...
$0ce8 o0ce8:   cd 92 02 CALL c0292
$0ceb          3e 0a    MVI A, #0a
$0ced          32 a7 21 STA $21a7
$0cf0          21 32 13 LXI H, #1332
$0cf3 o0cf3:   cd 61 12 CALL c1261
$0cf6 o0cf6:   c3 1e 06 JMP jo061e
...
$0d20          21 35 13 LXI H, #1335
$0d23 jo0d23:  cd 61 12 CALL c1261 ;o0d4a
$0d26 o0d26:   c3 1e 06 JMP jo061e
...
$0d3a          3a 94 21 LDA $2194
$0d3d          e6 fd    ANI #fd
$0d3f          32 94 21 STA $2194
$0d42          3e 00    MVI A, #00
$0d44          32 0c 22 STA $220c
$0d47          21 35 13 LXI H, #1335
$0d4a o0d4a:   c3 23 0d JMP jo0d23
$0d4d j0d4d:   21 c5 21 LXI H, #21c5 ;o0be4,o0bef
$0d50          3e 01    MVI A, #01
$0d52 o0d52:   cd d6 03 CALL c03d6
$0d55          3e 06    MVI A, #06
...
$0dc5 o0dc5:   cd 92 02 CALL c0292
$0dc8          21 e0 12 LXI H, #12e0
$0dcb o0dcb:   cd 61 12 CALL c1261
$0dce o0dce:   c3 e1 0d JMP j0de1
$0dd1 j0dd1:   21 71 11 LXI H, #1171 ;o0dbf
$0dd4 o0dd4:   cd 92 02 CALL c0292
$0dd7          eb       XCHG
$0dd8 o0dd8:   cd 5c 0e CALL c0e5c
$0ddb          21 f2 12 LXI H, #12f2
$0dde o0dde:   cd 61 12 CALL c1261
$0de1 j0de1:   3a 91 21 LDA $2191 ;o0da2,o0db9,o0dce
$0de4          e6 df    ANI #df
$0de6          32 91 21 STA $2191
$0de9 o0de9:   c3 1e 06 JMP jo061e
$0dec c0dec:   11 f3 21 LXI D, #21f3 ;o0e69,o0f73,o100b,o18b1
$0def          b7       ORA A
$0df0          f5       PUSH PSW
...
$0ee8          12       STAX D
$0ee9          c9       RET
$0eea c0eea:   0f       RRC ;o0e7f,o0ebf,o0f85,o0fe5,o0fee,o1044,o1c15
$0eeb          f5       PUSH PSW
...
$0f3a          12       STAX D
$0f3b          c9       RET
$0f3c c0f3c:   11 f3 21 LXI D, #21f3 ;o0278,o0d02,o1722,o172d,o18f3
$0f3f          3e 08    MVI A, #08
$0f41 o0f41:   cd cf 0e CALL c0ecf
$0f44          21 7e 23 LXI H, #237e
$0f47          3e 04    MVI A, #04
$0f49 o0f49:   cd ee 03 CALL c03ee
$0f4c o0f4c:   c2 dd 10 JNZ j10dd
$0f4f          3c       INR A
$0f50 o0f50:   cd ee 03 CALL c03ee
$0f53 o0f53:   c2 f4 10 JNZ j10f4
$0f56          3c       INR A
$0f57 o0f57:   cd ee 03 CALL c03ee
$0f5a o0f5a:   c2 0b 11 JNZ j110b
$0f5d          21 93 23 LXI H, #2393
$0f60          e5       PUSH H
$0f61          21 73 23 LXI H, #2373
$0f64          e5       PUSH H
$0f65          21 6b 23 LXI H, #236b
$0f68          e5       PUSH H
$0f69          21 90 23 LXI H, #2390
$0f6c          e5       PUSH H
$0f6d          21 6f 23 LXI H, #236f
$0f70          e5       PUSH H
$0f71 j0f71:   3e 08    MVI A, #08 ;o10f1,o1108,o111f
$0f73 o0f73:   cd ec 0d CALL c0dec
$0f76          d1       POP D
$0f77          d5       PUSH D
$0f78          21 f3 21 LXI H, #21f3
$0f7b          3e 08    MVI A, #08
$0f7d o0f7d:   cd cf 0e CALL c0ecf
$0f80          e1       POP H
$0f81          d1       POP D
$0f82          d5       PUSH D
$0f83          3e 06    MVI A, #06
$0f85 o0f85:   cd ea 0e CALL c0eea
$0f88          d1       POP D
$0f89          d5       PUSH D
...
$0f8e          eb       XCHG
$0f8f          3e 06    MVI A, #06
$0f91 o0f91:   cd cf 0e CALL c0ecf
$0f94          d1       POP D
...
$0fa0          3e 06    MVI A, #06
$0fa2 o0fa2:   cd cf 0e CALL c0ecf
$0fa5 j0fa5:   21 7e 23 LXI H, #237e ;o0f9a
$0fa8          3e 03    MVI A, #03
$0faa o0faa:   cd ee 03 CALL c03ee
...
$0fb8          fe 03    CPI #03
$0fba          c0       RNZ
$0fbb          21 63 23 LXI H, #2363
$0fbe          11 f3 21 LXI D, #21f3
$0fc1          3e 07    MVI A, #07
$0fc3 o0fc3:   cd cf 0e CALL c0ecf
$0fc6          21 6b 23 LXI H, #236b
$0fc9          3e 07    MVI A, #07
$0fcb o0fcb:   cd 18 0e CALL c0e18
$0fce          f5       PUSH PSW
$0fcf o0fcf:   dc f4 0f CC c0ff4
$0fd2          21 f3 21 LXI H, #21f3
$0fd5          11 77 23 LXI D, #2377
$0fd8          d5       PUSH D
$0fd9          3e 06    MVI A, #06
$0fdb o0fdb:   cd cf 0e CALL c0ecf
$0fde          e1       POP H
$0fdf          e5       PUSH H
$0fe0          11 97 23 LXI D, #2397
$0fe3          3e 06    MVI A, #06
$0fe5 o0fe5:   cd ea 0e CALL c0eea
$0fe8          e1       POP H
$0fe9          11 b7 23 LXI D, #23b7
$0fec          3e 06    MVI A, #06
$0fee o0fee:   cd ea 0e CALL c0eea
$0ff1 o0ff1:   c3 52 10 JMP j1052
$0ff4 c0ff4:   21 6b 23 LXI H, #236b ;o0fcf
$0ff7          11 f3 21 LXI D, #21f3
$0ffa          3e 07    MVI A, #07
$0ffc o0ffc:   cd cf 0e CALL c0ecf
$0fff          21 63 23 LXI H, #2363
$1002          3e 07    MVI A, #07
...
$100e          21 f3 21 LXI H, #21f3
$1011          d1       POP D
$1012          d5       PUSH D
$1013          3e 07    MVI A, #07
$1015 o1015:   cd cf 0e CALL c0ecf
$1018          e1       POP H
$1019          d1       POP D
$101a          21 67 23 LXI H, #2367
$101d          11 f3 21 LXI D, #21f3
$1020          3e 07    MVI A, #07
$1022 o1022:   cd cf 0e CALL c0ecf
$1025          21 73 23 LXI H, #2373
$1028          3e 07    MVI A, #07
$102a o102a:   cd 18 0e CALL c0e18
$102d          f5       PUSH PSW
$102e o102e:   da 22 11 JC j1122
$1031 j1031:   21 f3 21 LXI H, #21f3 ;o1135
$1034          11 77 23 LXI D, #2377
$1037          3e 06    MVI A, #06
$1039 o1039:   cd cf 0e CALL c0ecf
$103c          21 77 23 LXI H, #2377
$103f          11 97 23 LXI D, #2397
$1042          3e 06    MVI A, #06
$1044 o1044:   cd ea 0e CALL c0eea
$1047          21 97 23 LXI H, #2397
$104a          11 b7 23 LXI D, #23b7
$104d          3e 06    MVI A, #06
$104f o104f:   cd cf 0e CALL c0ecf
$1052 j1052:   3a f6 21 LDA $21f6 ;o0ff1
$1055          e6 0f    ANI #0f
$1057 o1057:   ca 65 10 JZ j1065
$105a          21 89 11 LXI H, #1189
$105d          11 97 23 LXI D, #2397
$1060          3e 06    MVI A, #06
$1062 o1062:   cd cf 0e CALL c0ecf
$1065 j1065:   f1       POP PSW ;o1057
$1066 o1066:   ca b5 10 JZ j10b5
$1069 o1069:   da a1 10 JC j10a1
$106c          21 6a 23 LXI H, #236a
$106f          3e 04    MVI A, #04
$1071 o1071:   cd ee 03 CALL c03ee
$1074 o1074:   ca 78 10 JZ jo1078
$1077          c9       RET
$1078 jo1078:  cd d6 03 CALL c03d6 ;o1074
$107b          3e 05    MVI A, #05
$107d jo107d:  cd e1 03 CALL c03e1 ;o10b2
$1080          e5       PUSH H
$1081          c5       PUSH B
$1082          21 16 13 LXI H, #1316
$1085 o1085:   cd 61 12 CALL c1261
...
$10a4          3e 05    MVI A, #05
$10a6 o10a6:   cd ee 03 CALL c03ee
$10a9 o10a9:   ca ad 10 JZ jo10ad
$10ac          c9       RET
$10ad jo10ad:  cd d6 03 CALL c03d6 ;o10a9
$10b0          3e 04    MVI A, #04
$10b2 o10b2:   c3 7d 10 JMP jo107d
$10b5 j10b5:   21 6a 23 LXI H, #236a ;o1066
$10b8          3e 04    MVI A, #04
$10ba o10ba:   cd e1 03 CALL c03e1
$10bd          3e 05    MVI A, #05
$10bf o10bf:   cd e1 03 CALL c03e1
$10c2          e5       PUSH H
$10c3          21 85 11 LXI H, #1185
$10c6          11 97 23 LXI D, #2397
$10c9          3e 06    MVI A, #06
$10cb o10cb:   cd cf 0e CALL c0ecf
$10ce          21 85 11 LXI H, #1185
$10d1          11 b7 23 LXI D, #23b7
$10d4          3e 06    MVI A, #06
$10d6 o10d6:   cd cf 0e CALL c0ecf
$10d9          e1       POP H
$10da o10da:   c3 38 11 JMP j1138
$10dd j10dd:   21 89 23 LXI H, #2389 ;o0f4c
$10e0          e5       PUSH H
$10e1          21 67 23 LXI H, #2367
$10e4          e5       PUSH H
$10e5          21 5f 23 LXI H, #235f
$10e8          e5       PUSH H
$10e9          21 86 23 LXI H, #2386
$10ec          e5       PUSH H
$10ed          21 63 23 LXI H, #2363
$10f0          e5       PUSH H
$10f1 o10f1:   c3 71 0f JMP j0f71
$10f4 j10f4:   21 93 23 LXI H, #2393 ;o0f53
$10f7          e5       PUSH H
$10f8          21 73 23 LXI H, #2373
$10fb          e5       PUSH H
$10fc          21 6f 23 LXI H, #236f
$10ff          e5       PUSH H
$1100          21 8d 23 LXI H, #238d
$1103          e5       PUSH H
$1104          21 6b 23 LXI H, #236b
$1107          e5       PUSH H
$1108 o1108:   c3 71 0f JMP j0f71
$110b j110b:   21 89 23 LXI H, #2389 ;o0f5a
$110e          e5       PUSH H
$110f          21 67 23 LXI H, #2367
$1112          e5       PUSH H
$1113          21 63 23 LXI H, #2363
$1116          e5       PUSH H
$1117          21 83 23 LXI H, #2383
$111a          e5       PUSH H
$111b          21 5f 23 LXI H, #235f
$111e          e5       PUSH H
$111f o111f:   c3 71 0f JMP j0f71
$1122 j1122:   21 73 23 LXI H, #2373 ;o102e
$1125          11 f3 21 LXI D, #21f3
$1128          3e 07    MVI A, #07
$112a o112a:   cd cf 0e CALL c0ecf
$112d          21 67 23 LXI H, #2367
$1130          3e 07    MVI A, #07
...
$11f3          21 90 21 LXI H, #2190
$11f6          3e 05    MVI A, #05
$11f8 o11f8:   cd d6 03 CALL c03d6
$11fb          c9       RET
$11fc          0d       DCR C
$11fd          0a       LDAX B
$11fe          0e 0a    MVI C, #0a
...
$120b o120b:   cd ee 03 CALL c03ee
$120e o120e:   c2 22 12 JNZ jo1222
$1211          3e 06    MVI A, #06
$1213 o1213:   cd d6 03 CALL c03d6
$1216          3e fe    MVI A, #fe
$1218          d3 09    OUT #09
$121a          3e 02    MVI A, #02
$121c          32 98 21 STA $2198
$121f o121f:   c3 1e 06 JMP jo061e
$1222 jo1222:  cd e1 03 CALL c03e1 ;o120e
$1225          3e 06    MVI A, #06
$1227 o1227:   cd ee 03 CALL c03ee
$122a o122a:   c2 55 12 JNZ jo1255
$122d          3e ff    MVI A, #ff
$122f          d3 09    OUT #09
$1231          2a b1 21 LHLD $21b1
$1234          23       INX H
$1235          7e       MOV A,M
$1236          fe ff    CPI #ff
$1238 o1238:   ca 41 12 JZ j1241
$123b o123b:   cd 8d 11 CALL c118d
$123e o123e:   c3 1e 06 JMP jo061e
...
$1252 o1252:   c3 1e 06 JMP jo061e
$1255 jo1255:  cd e1 03 CALL c03e1 ;o122a
...
$127a          21 90 21 LXI H, #2190
$127d          3e 05    MVI A, #05
$127f o127f:   cd ee 03 CALL c03ee
$1282          c0       RNZ
$1283 o1283:   cd d6 03 CALL c03d6
$1286          3e 01    MVI A, #01
...
$12de          08       (DSUB)
$12df          ff       RST 7
$12e0          22 08 ff SHLD $ff08
$12e3          22 28 1e SHLD $1e28
$12e6          0c       INR C
$12e7          ff       RST 7
$12e8          15       DCR D
$12e9          02       STAX B
...
$1336          0c       INR C
$1337          ff       RST 7
$1338          ca 08 ca DB 0xca,0x8,0xca  ; (was:          ca 08 ca JZ $ca08)
$133b          08       (DSUB)
$133c          ca 08 ca DB 0xca,0x8,0xca  ; (was:          ca 08 ca JZ $ca08)
$133f          0c       INR C
$1340          ff       RST 7
$1341          78       MOV A,B
$1342          28 65    (LDHI) #65
...
$134c          0c       INR C
$134d          ff       RST 7
$134e          ca 00 ff DB 0xca,0x0,0xff  ; (was:          ca 00 ff JZ $ff00)
$1351          65       MOV H,L
$1352          0c       INR C
$1353          87       ADD A
$1354          0c       INR C
$1355          aa       XRA D
$1356          0c       INR C
$1357          ca 0c ca DB 0xca,0xc,0xca  ; (was:          ca 0c ca JZ $ca0c)
$135a          00       NOP
$135b          ca 08 ca DB 0xca,0x8,0xca  ; (was:          ca 08 ca JZ $ca08)
$135e          08       (DSUB)
$135f          ca 08 aa DB 0xca,0x8,0xaa  ; (was:          ca 08 aa JZ $aa08)
$1362          00       NOP
$1363          aa       XRA D
$1364          0c       INR C
$1365          aa       XRA D
...
$137c          fe 21    CPI #21
$137e          91       SUB C
$137f          21 3e 03 LXI H, #033e
$1382 o1382:   cd e1 03 CALL c03e1
$1385          d3 0f    OUT #0f
...
$13b0          e6 08    ANI #08
$13b2          c2 7d 13 DB 0xc2,0x7d,0x13  ; (was:          c2 7d 13 JNZ $137d)
$13b5 o13b5:   cd 03 03 CALL c0303
$13b8          22 24 22 SHLD $2224
$13bb          c9       RET
$13bc          21 91 21 LXI H, #2191
$13bf          3e 06    MVI A, #06
$13c1 o13c1:   cd d6 03 CALL c03d6
...
$13d7          3e 06    MVI A, #06
$13d9 o13d9:   cd ee 03 CALL c03ee
$13dc o13dc:   ca e4 13 JZ j13e4
$13df          3e 07    MVI A, #07
$13e1 o13e1:   cd e1 03 CALL c03e1
...
$13ef          3e 06    MVI A, #06
$13f1 o13f1:   cd e1 03 CALL c03e1
$13f4          3c       INR A
$13f5 o13f5:   cd ee 03 CALL c03ee
$13f8 o13f8:   c2 02 14 JNZ jo1402
$13fb o13fb:   cd d6 03 CALL c03d6
$13fe          e1       POP H
$13ff o13ff:   c3 1c 14 JMP jo141c
$1402 jo1402:  cd e1 03 CALL c03e1 ;o13f8
$1405          e1       POP H
$1406 o1406:   cd 24 06 CALL c0624
$1409          7d       MOV A,L
$140a          d6 e0    SUI #e0
$140c          6f       MOV L,A
$140d          26 00    MVI H, #00
...
$1417          6f       MOV L,A
$1418          e9       PCHL
$1419 jo1419:  cd 30 06 CALL c0630 ;o0996,o09ab,o09b8,o09d7,o0a27,o0b60,o0b6c,o0cab,o0d5a,o0d7e,o0d9a,o14a1,o14ab,o14c5,o14d2,o153e,o1549,o15a9,o15c1,o15d3,o15de,o15e6,o15f8,o1810,o1820,o1828,o1886,o18ca
...
$1490          0e 07    MVI C, #07
$1492          06 0a    MVI B, #0a
$1494 j1494:   21 90 21 LXI H, #2190 ;o1463,o146a,o1471,o1478,o147f,o1486,o148d
$1497          3e 07    MVI A, #07
$1499 o1499:   cd d6 03 CALL c03d6
$149c          3e 02    MVI A, #02
$149e o149e:   cd ee 03 CALL c03ee
$14a1 o14a1:   c2 19 14 JNZ jo1419
$14a4          79       MOV A,C
$14a5          21 c6 21 LXI H, #21c6
$14a8 o14a8:   cd ee 03 CALL c03ee
$14ab o14ab:   ca 19 14 JZ jo1419
$14ae o14ae:   cd e1 03 CALL c03e1
$14b1 o14b1:   cd 81 1d CALL co1d81
$14b4          21 61 11 LXI H, #1161
$14b7 o14b7:   cd 92 02 CALL c0292
$14ba          21 d7 12 LXI H, #12d7
$14bd o14bd:   cd 61 12 CALL c1261
...
$14ef o14ef:   cd 61 12 CALL c1261
$14f2          3e 0a    MVI A, #0a
$14f4          32 a4 21 STA $21a4
$14f7 o14f7:   c3 1e 06 JMP jo061e
...
$152b o152b:   c3 1e 06 JMP jo061e
$152e          02       STAX B
$152f          2a 10 1a LHLD $1a10
$1532          01 19 21 LXI B, #2119
$1535          0a       LDAX B
$1536          21 90 21 LXI H, #2190
$1539          3e 07    MVI A, #07
$153b o153b:   cd ee 03 CALL c03ee
$153e o153e:   ca 19 14 JZ jo1419
$1541 o1541:   cd e1 03 CALL c03e1
$1544          3e 02    MVI A, #02
$1546 o1546:   cd ee 03 CALL c03ee
$1549 o1549:   c2 19 14 JNZ jo1419
$154c          21 7d 11 LXI H, #117d
$154f o154f:   cd 5c 0e CALL c0e5c
$1552          21 90 21 LXI H, #2190
$1555          3e 04    MVI A, #04
$1557 o1557:   cd ee 03 CALL c03ee
$155a o155a:   ca 88 15 JZ j1588
$155d          21 91 21 LXI H, #2191
$1560          3e 01    MVI A, #01
$1562 o1562:   cd ee 03 CALL c03ee
$1565 o1565:   c2 88 15 JNZ j1588
$1568 o1568:   cd d6 03 CALL c03d6
...
$1582          21 38 13 LXI H, #1338
$1585 o1585:   cd 61 12 CALL c1261
$1588 j1588:   21 90 21 LXI H, #2190 ;o155a,o1565
$158b          3e 03    MVI A, #03
$158d o158d:   cd ee 03 CALL c03ee
...
$15a3 j15a3:   21 ed 12 LXI H, #12ed ;o1590,o1598
$15a6 o15a6:   cd 61 12 CALL c1261
$15a9 o15a9:   c3 19 14 JMP jo1419
$15ac          3e ff    MVI A, #ff
$15ae          32 93 21 STA $2193
$15b1          3a 94 21 LDA $2194
$15b4          f6 30    ORI #30
$15b6          32 94 21 STA $2194
$15b9          21 90 21 LXI H, #2190
$15bc          3e 02    MVI A, #02
$15be o15be:   cd ee 03 CALL c03ee
$15c1 o15c1:   c2 19 14 JNZ jo1419
$15c4 o15c4:   cd d6 03 CALL c03d6
$15c7          21 65 11 LXI H, #1165
$15ca o15ca:   cd 92 02 CALL c0292
$15cd          21 4b 13 LXI H, #134b
$15d0 o15d0:   cd 61 12 CALL c1261
$15d3 o15d3:   c3 19 14 JMP jo1419
$15d6          21 90 21 LXI H, #2190
$15d9          3e 02    MVI A, #02
$15db o15db:   cd ee 03 CALL c03ee
$15de o15de:   c2 19 14 JNZ jo1419
$15e1          3e 07    MVI A, #07
$15e3 o15e3:   cd ee 03 CALL c03ee
$15e6 o15e6:   ca 19 14 JZ jo1419
$15e9 o15e9:   cd e1 03 CALL c03e1
$15ec          21 65 11 LXI H, #1165
$15ef o15ef:   cd 5c 0e CALL c0e5c
$15f2          21 35 13 LXI H, #1335
$15f5 o15f5:   cd 61 12 CALL c1261
$15f8 o15f8:   c3 19 14 JMP jo1419
$15fb          21 92 21 LXI H, #2192
$15fe          3e 00    MVI A, #00
$1600 o1600:   cd ee 03 CALL c03ee
$1603 o1603:   c2 89 17 JNZ j1789
$1606          3a 7a 23 LDA $237a
$1609          b7       ORA A
...
$1620 j1620:   3a 7b 23 LDA $237b ;o160a
$1623          e6 0f    ANI #0f
$1625          fe 01    CPI #01
...
$1635          3e 2e    MVI A, #2e
$1637 o1637:   cd cf 0e CALL c0ecf
$163a o163a:   cd a8 17 CALL c17a8
$163d          21 92 21 LXI H, #2192
$1640          3e 04    MVI A, #04
$1642 o1642:   cd ee 03 CALL c03ee
$1645 o1645:   ca 55 16 JZ j1655
$1648          3e 07    MVI A, #07
$164a o164a:   cd ee 03 CALL c03ee
$164d o164d:   ca 55 16 JZ j1655
$1650          3e 01    MVI A, #01
$1652 o1652:   c3 71 16 JMP j1671
$1655 j1655:   3e 06    MVI A, #06 ;o1645,o164d
$1657 o1657:   cd d6 03 CALL c03d6
$165a          3a 90 21 LDA $2190
$165d          f6 05    ORI #05
$165f          32 90 21 STA $2190
$1662          3e ff    MVI A, #ff
$1664          32 93 21 STA $2193
$1667          3a 94 21 LDA $2194
$166a          f6 30    ORI #30
$166c          32 94 21 STA $2194
$166f          3e 00    MVI A, #00
$1671 j1671:   32 7b 23 STA $237b ;o1652
$1674          32 9b 23 STA $239b
$1677          32 bb 23 STA $23bb
$167a          3e 11    MVI A, #11
...
$1687          3e f0    MVI A, #f0
$1689          32 86 23 STA $2386
$168c          32 a6 23 STA $23a6
...
$16a2          21 92 21 LXI H, #2192
$16a5          3e 06    MVI A, #06
$16a7 o16a7:   cd e1 03 CALL c03e1
...
$16b8          3e 10    MVI A, #10
$16ba o16ba:   cd cf 0e CALL c0ecf
$16bd          21 c9 21 LXI H, #21c9
$16c0          11 ce 21 LXI D, #21ce
$16c3          3e 0a    MVI A, #0a
$16c5 o16c5:   cd cf 0e CALL c0ecf
$16c8          3a 90 21 LDA $2190
$16cb          e6 e7    ANI #e7
$16cd          32 90 21 STA $2190
$16d0 j16d0:   3a 7a 23 LDA $237a ;o1735,o174b,o176d,o1780
$16d3          c6 99    ADI #99
$16d5          27       DAA
$16d6          32 7a 23 STA $237a
$16d9          32 9a 23 STA $239a
$16dc          32 ba 23 STA $23ba
$16df          3a 14 22 LDA $2214
$16e2          47       MOV B,A
$16e3          3a 13 22 LDA $2213
$16e6          80       ADD B
...
$16fa o16fa:   cd ee 03 CALL c03ee
$16fd o16fd:   ca 38 17 JZ jo1738
$1700          3e 02    MVI A, #02
$1702 o1702:   cd ee 03 CALL c03ee
$1705 o1705:   ca 4e 17 JZ jo174e
$1708          3e 03    MVI A, #03
$170a o170a:   cd d6 03 CALL c03d6
$170d          3e f0    MVI A, #f0
$170f          32 90 23 STA $2390
$1712          32 b0 23 STA $23b0
$1715          f3       DI
...
$1734          fb       EI
$1735 o1735:   c3 d0 16 JMP j16d0
$1738 jo1738:  cd d6 03 CALL c03d6 ;o16fd
$173b          3e f0    MVI A, #f0
$173d          32 8d 23 STA $238d
$1740          32 ad 23 STA $23ad
$1743          3e f0    MVI A, #f0
$1745          32 97 23 STA $2397
$1748          32 b7 23 STA $23b7
$174b o174b:   c3 d0 16 JMP j16d0
$174e jo174e:  cd d6 03 CALL c03d6 ;o1705
$1751          3e f0    MVI A, #f0
$1753          32 83 23 STA $2383
$1756          32 a3 23 STA $23a3
$1759          3e ff    MVI A, #ff
$175b          32 97 23 STA $2397
$175e          32 98 23 STA $2398
$1761          32 99 23 STA $2399
$1764          32 b7 23 STA $23b7
$1767          32 b8 23 STA $23b8
$176a          32 b9 23 STA $23b9
$176d o176d:   c3 d0 16 JMP j16d0
...
$1780 o1780:   c3 d0 16 JMP j16d0
$1783 j1783:   21 da 12 LXI H, #12da ;o16ea
$1786 o1786:   cd 61 12 CALL c1261
...
$17ef          3e 20    MVI A, #20
$17f1          c8       RZ
$17f2          21 90 21 LXI H, #2190
$17f5          3e 03    MVI A, #03
$17f7 o17f7:   cd ee 03 CALL c03ee
$17fa          3e 20    MVI A, #20
$17fc          c0       RNZ
...
$1805          3e 80    MVI A, #80
$1807          c9       RET
$1808          21 92 21 LXI H, #2192
$180b          3e 04    MVI A, #04
$180d o180d:   cd ee 03 CALL c03ee
...
$183e          3a 94 21 LDA $2194
$1841          f6 30    ORI #30
$1843          32 94 21 STA $2194
$1846          21 90 21 LXI H, #2190
$1849          3e 02    MVI A, #02
$184b o184b:   cd d6 03 CALL c03d6
$184e          21 92 21 LXI H, #2192
$1851          3e 04    MVI A, #04
$1853 o1853:   cd d6 03 CALL c03d6
$1856          21 e8 12 LXI H, #12e8
$1859 o1859:   cd 61 12 CALL c1261
$185c o185c:   cd a8 1b CALL c1ba8
$185f          eb       XCHG
$1860          21 c6 21 LXI H, #21c6
$1863          3e 10    MVI A, #10
$1865 o1865:   cd cf 0e CALL c0ecf
$1868          21 90 21 LXI H, #2190
$186b          3e 00    MVI A, #00
$186d o186d:   cd ee 03 CALL c03ee
...
$189e          21 f3 21 LXI H, #21f3
$18a1          11 0d 22 LXI D, #220d
$18a4          3e 06    MVI A, #06
$18a6 o18a6:   cd cf 0e CALL c0ecf
$18a9          3e 04    MVI A, #04
...
$18b9          21 f3 21 LXI H, #21f3
$18bc o18bc:   cd 6f 0e CALL c0e6f
$18bf          3e 3c    MVI A, #3c
$18c1          32 ae 21 STA $21ae
$18c4          21 35 13 LXI H, #1335
$18c7 o18c7:   cd 61 12 CALL c1261
...
$18d9 o18d9:   cd 92 02 CALL c0292
$18dc          3e 0a    MVI A, #0a
$18de          32 ae 21 STA $21ae
$18e1          21 32 13 LXI H, #1332
$18e4 o18e4:   cd 61 12 CALL c1261
$18e7 o18e7:   c3 1e 06 JMP jo061e
...
$1911 o1911:   c3 1e 06 JMP jo061e
$1914 j1914:   3e 01    MVI A, #01 ;o1909
$1916          32 12 22 STA $2212
$1919          3e 32    MVI A, #32
$191b          32 94 21 STA $2194
$191e          21 92 21 LXI H, #2192
$1921          3e 03    MVI A, #03
$1923 o1923:   cd e1 03 CALL c03e1
$1926          21 7b 23 LXI H, #237b
$1929          3a 13 22 LDA $2213
$192c          96       SUB M
...
$193b j193b:   3a 7b 23 LDA $237b ;o192d
$193e          b7       ORA A
$193f          3e 01    MVI A, #01
$1941          21 7e 23 LXI H, #237e
$1944 o1944:   ca 8a 1a JZ j1a8a
$1947          3e 04    MVI A, #04
$1949 jo1949:  cd ee 03 CALL c03ee ;o1952
$194c o194c:   c2 55 19 JNZ jo1955
$194f          3c       INR A
$1950          fe 08    CPI #08
$1952 o1952:   c2 49 19 JNZ jo1949
$1955 jo1955:  cd e1 03 CALL c03e1 ;o194c
$1958          3c       INR A
$1959          4f       MOV C,A
$195a          d6 04    SUI #04
$195c o195c:   cd ee 03 CALL c03ee
$195f          79       MOV A,C
$1960 o1960:   c2 98 1a JNZ jo1a98
$1963          3a 13 22 LDA $2213
$1966          3c       INR A
$1967          47       MOV B,A
$1968          3a 7b 23 LDA $237b
$196b          3c       INR A
$196c          b8       CMP B
$196d o196d:   c2 8a 1a JNZ j1a8a
$1970          32 7b 23 STA $237b
$1973          32 bb 23 STA $23bb
$1976 j1976:   3e ff    MVI A, #ff ;o1938
$1978          32 9b 23 STA $239b
...
$199d o199d:   cd e1 03 CALL c03e1
$19a0          c6 04    ADI #04
$19a2          eb       XCHG
$19a3 o19a3:   cd d6 03 CALL c03d6
...
$19b4          3a 90 21 LDA $2190
$19b7          f6 08    ORI #08
$19b9          32 90 21 STA $2190
$19bc o19bc:   c3 ae 1a JMP j1aae
$19bf j19bf:   21 91 21 LXI H, #2191 ;o197f
$19c2          3e 00    MVI A, #00
$19c4 o19c4:   cd ee 03 CALL c03ee
$19c7          3e 01    MVI A, #01
$19c9 o19c9:   c2 8a 1a JNZ j1a8a
$19cc          3a 92 21 LDA $2192
$19cf          f6 c0    ORI #c0
$19d1          32 92 21 STA $2192
$19d4 o19d4:   cd b7 1d CALL c1db7
$19d7          21 b6 23 LXI H, #23b6
$19da          3e 07    MVI A, #07
$19dc o19dc:   cd d6 03 CALL c03d6
...
$1a24 j1a24:   21 ff 12 LXI H, #12ff ;o1a14
$1a27 o1a27:   cd 61 12 CALL c1261
$1a2a j1a2a:   3e 00    MVI A, #00 ;o1a21
$1a2c          32 9b 23 STA $239b
$1a2f          32 bb 23 STA $23bb
$1a32          3e fa    MVI A, #fa
$1a34          32 9e 21 STA $219e
$1a37 o1a37:   c3 1e 06 JMP jo061e
...
$1a6e o1a6e:   c3 1e 06 JMP jo061e
$1a71 jo1a71:  cd d3 06 CALL c06d3 ;o1a66
$1a74          3a 47 22 LDA $2247
$1a77          e6 f7    ANI #f7
$1a79          32 47 22 STA $2247
$1a7c          3e 07    MVI A, #07
$1a7e          21 b3 23 LXI H, #23b3
$1a81          11 93 23 LXI D, #2393
$1a84 o1a84:   cd cf 0e CALL c0ecf
$1a87 o1a87:   c3 1e 06 JMP jo061e
$1a8a j1a8a:   32 7b 23 STA $237b ;o1944,o196d,o19c9
$1a8d          32 9b 23 STA $239b
$1a90          32 bb 23 STA $23bb
$1a93          3e 04    MVI A, #04
$1a95          21 7e 23 LXI H, #237e
$1a98 jo1a98:  cd d6 03 CALL c03d6 ;o1960
$1a9b          3a 13 22 LDA $2213
$1a9e          4f       MOV C,A
$1a9f          3a 7b 23 LDA $237b
$1aa2          b9       CMP C
$1aa3 o1aa3:   c2 ae 1a JNZ j1aae
$1aa6          21 90 21 LXI H, #2190
$1aa9          3e 04    MVI A, #04
$1aab o1aab:   cd d6 03 CALL c03d6
$1aae j1aae:   3a 7e 23 LDA $237e ;o19bc,o1aa3
$1ab1          32 be 23 STA $23be
$1ab4          47       MOV B,A
$1ab5          e6 0f    ANI #0f
$1ab7          32 9e 23 STA $239e
$1aba          21 90 21 LXI H, #2190
$1abd          3e 00    MVI A, #00
$1abf o1abf:   cd e1 03 CALL c03e1
$1ac2          06 09    MVI B, #09
$1ac4 o1ac4:   cd 81 1d CALL co1d81
$1ac7          21 b6 23 LXI H, #23b6
$1aca          3e 04    MVI A, #04
$1acc o1acc:   cd e1 03 CALL c03e1
$1acf          3e 02    MVI A, #02
$1ad1          32 a1 21 STA $21a1
$1ad4 o1ad4:   c3 1e 06 JMP jo061e
$1ad7          3a 12 22 LDA $2212
$1ada          3d       DCR A
$1adb          32 12 22 STA $2212
$1ade o1ade:   ca ef 1a JZ j1aef
$1ae1          21 21 13 LXI H, #1321
$1ae4 o1ae4:   cd 61 12 CALL c1261
$1ae7          3e a0    MVI A, #a0
$1ae9          32 a1 21 STA $21a1
$1aec o1aec:   c3 1e 06 JMP jo061e
...
$1b07          3e 10    MVI A, #10
$1b09 o1b09:   cd cf 0e CALL c0ecf
$1b0c          21 c9 21 LXI H, #21c9
$1b0f          11 ce 21 LXI D, #21ce
$1b12          3e 0a    MVI A, #0a
$1b14 o1b14:   cd cf 0e CALL c0ecf
$1b17          06 2b    MVI B, #2b
...
$1b67          21 92 21 LXI H, #2192
$1b6a          3e 07    MVI A, #07
$1b6c o1b6c:   cd d6 03 CALL c03d6
$1b6f          21 46 13 LXI H, #1346
$1b72 o1b72:   cd 61 12 CALL c1261
...
$1b93 j1b93:   3a 7a 23 LDA $237a ;o1b8c
$1b96          90       SUB B
...
$1ba5 jo1ba5:  c3 1e 06 JMP jo061e ;o1b7e,o1b81,o1b97,o1b9f
...
$1c23          21 b3 23 LXI H, #23b3
$1c26 j1c26:   11 93 23 LXI D, #2393 ;o1c20
$1c29          3e 07    MVI A, #07
$1c2b o1c2b:   cd cf 0e CALL c0ecf
$1c2e          3a 92 21 LDA $2192
$1c31          e6 40    ANI #40
$1c33 o1c33:   ca 4e 1c JZ j1c4e
$1c36          3a 7a 23 LDA $237a
$1c39          b7       ORA A
$1c3a          21 b6 23 LXI H, #23b6
$1c3d          3e 06    MVI A, #06
$1c3f o1c3f:   c2 48 1c JNZ jo1c48
$1c42 o1c42:   cd d6 03 CALL c03d6
$1c45 o1c45:   c3 d2 01 JMP j01d2
$1c48 jo1c48:  cd e1 03 CALL c03e1 ;o1c3f
...
$1c68          3e 00    MVI A, #00
$1c6a o1c6a:   cd e1 03 CALL c03e1
$1c6d          32 9f 21 STA $219f
$1c70 o1c70:   c3 d2 01 JMP j01d2
$1c73 j1c73:   21 92 21 LXI H, #2192 ;o1bc2
$1c76          3e 00    MVI A, #00
$1c78 o1c78:   cd ee 03 CALL c03ee
$1c7b o1c7b:   c2 2c 02 JNZ j022c
$1c7e o1c7e:   cd d6 03 CALL c03d6
$1c81          21 80 23 LXI H, #2380
$1c84          11 4b 22 LXI D, #224b
$1c87          3e 80    MVI A, #80
$1c89 o1c89:   cd cf 0e CALL c0ecf
$1c8c          3e ff    MVI A, #ff
$1c8e          21 83 23 LXI H, #2383
$1c91          06 17    MVI B, #17
...
$1ca4          3e 2e    MVI A, #2e
$1ca6 o1ca6:   cd cf 0e CALL c0ecf
...
$1cce          21 92 21 LXI H, #2192
$1cd1          3e 06    MVI A, #06
$1cd3 o1cd3:   cd ee 03 CALL c03ee
...
$1ce8          3a bb 23 LDA $23bb
$1ceb          32 9b 23 STA $239b
...
$1d1d          3e 05    MVI A, #05
$1d1f o1d1f:   cd d6 03 CALL c03d6
...
$1d32          3e 00    MVI A, #00
$1d34          32 94 21 STA $2194
$1d37          3a 90 21 LDA $2190
$1d3a          e6 38    ANI #38
$1d3c          f6 80    ORI #80
$1d3e          32 90 21 STA $2190
$1d41          3a 92 21 LDA $2192
$1d44          e6 67    ANI #67
$1d46          32 92 21 STA $2192
$1d49          21 91 21 LXI H, #2191
$1d4c          3e 01    MVI A, #01
$1d4e o1d4e:   cd e1 03 CALL c03e1
$1d51          21 94 21 LXI H, #2194
$1d54          3e 04    MVI A, #04
$1d56 o1d56:   cd d6 03 CALL c03d6
$1d59          3e 06    MVI A, #06
...
$1d69          3e 05    MVI A, #05
$1d6b o1d6b:   cd e1 03 CALL c03e1
$1d6e          f3       DI
$1d6f          cd 7d 13 DB 0xcd,0x7d,0x13  ; (was:          cd 7d 13 CALL $137d)
$1d72          fb       EI
$1d73 o1d73:   c3 1e 06 JMP jo061e
$1d76 co1d76:  cd a3 1d CALL c1da3 ;o0ad6,o0b23,o0b3b,o0b63,o0e95,o14e9,o1511,o151c,o1b19,o1b1e,o1b23,o1b28,o1b2d,o1ba2
$1d79 o1d79:   cd d6 03 CALL c03d6
$1d7c          19       DAD D
$1d7d o1d7d:   cd d6 03 CALL c03d6
$1d80          c9       RET
...
$1d84 o1d84:   cd e1 03 CALL c03e1
$1d87          19       DAD D
$1d88 o1d88:   cd ee 03 CALL c03ee
$1d8b          f5       PUSH PSW
$1d8c o1d8c:   cd e1 03 CALL c03e1
$1d8f          f1       POP PSW
$1d90          c9       RET
$1d91 co1d91:  cd a3 1d CALL c1da3 ;jo0a14,o15a0
$1d94 o1d94:   cd d6 03 CALL c03d6
$1d97          19       DAD D
$1d98 o1d98:   cd e1 03 CALL c03e1
$1d9b          c9       RET
$1d9c co1d9c:  cd a3 1d CALL c1da3 ;o0a03,o0b1b,o0b5d,o0be1,o0c07,o0c14,o0c26,o0db6,o1501,o1509,o1595,o1875,o1b9c
$1d9f o1d9f:   cd ee 03 CALL c03ee
$1da2          c9       RET
...
$1f3e          3e 07    MVI A, #07
$1f40 o1f40:   cd cf 0e CALL c0ecf
$1f43          d1       POP D
$1f44          f1       POP PSW
$1f45          3d       DCR A
$1f46          c8       RZ
...
$1f4b          e5       PUSH H
$1f4c          3e 07    MVI A, #07
$1f4e o1f4e:   cd cf 0e CALL c0ecf
$1f51          d1       POP D
$1f52          f1       POP PSW
$1f53          3d       DCR A
$1f54          c8       RZ
...
$1f70 o1f70:   cd 61 12 CALL c1261
...
$1f88          3e 07    MVI A, #07
$1f8a o1f8a:   cd cf 0e CALL c0ecf
$1f8d          3f       CMC
$1f8e          c9       RET
...
$1f99          3e 07    MVI A, #07
$1f9b o1f9b:   cd cf 0e CALL c0ecf
$1f9e          3f       CMC
$1f9f          c9       RET
$1fa0 c1fa0:   11 39 22 LXI D, #2239 ;o1ec6,o1efc,o1f20,o1f32
$1fa3          3e 07    MVI A, #07
$1fa5 o1fa5:   cd cf 0e CALL c0ecf
$1fa8          3f       CMC
$1fa9          c9       RET
...
$1fba          e5       PUSH H
$1fbb          3e 07    MVI A, #07
$1fbd o1fbd:   cd cf 0e CALL c0ecf
$1fc0          d1       POP D
$1fc1          21 39 22 LXI H, #2239
$1fc4          e5       PUSH H
$1fc5          3e 07    MVI A, #07
$1fc7 o1fc7:   cd cf 0e CALL c0ecf
$1fca          21 81 11 LXI H, #1181
$1fcd          d1       POP D
$1fce          3e 07    MVI A, #07
$1fd0 o1fd0:   cd cf 0e CALL c0ecf
$1fd3          c9       RET
$1fd4 c1fd4:   11 f3 21 LXI D, #21f3 ;o1dba,o1de0,o1df2,o1e1a,o1e2c,o1e3c,o1e85,o1e97,o1ea9,o1ebb,o1ecd,o1edf,o1ef1,o1f03,o1f15,o1f27
$1fd7          3e 00    MVI A, #00
$1fd9          06 04    MVI B, #04
...
$1fe1          11 f3 21 LXI D, #21f3
$1fe4          3e 07    MVI A, #07
$1fe6 o1fe6:   cd cf 0e CALL c0ecf
$1fe9          3e 07    MVI A, #07
$1feb          c9       RET
$1fec          00       NOP
$1fed          00       NOP
